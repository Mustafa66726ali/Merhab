...
const navItems = [
  { href: "/platform/dashboard", label: "لوحة التحكم", icon: "dashboard" },
  { href: "/platform/events", label: "إدارة المناسبات", icon: "calendar_month" },
  { href: "/platform/users", label: "الأعضاء والطاقم", icon: "group" },
  { href: "/platform/reports", label: "التقارير والإحصائيات", icon: "analytics" },
  { href: "/platform/guests", label: "الضيوف", icon: "group" },
  { href: "/platform/notifications", label: "الإشعارات", icon: "notifications" },
  { href: "/platform/messages", label: "الرسائل", icon: "mail" },
...
export default function PlatformSidebar({ isOpen, onClose }: PlatformSidebarProps) {
