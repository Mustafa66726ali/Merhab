...
const navItems = [
  { href: "/entry-manager/check-in", label: "تسجيل الدخول", icon: "qr_code_scanner" },
  { href: "/entry-manager/account", label: "الحساب", icon: "account_circle" },
];

interface EntryManagerSidebarProps {
  isOpen: boolean;
  onClose: () => void;
}

export default function EntryManagerSidebar({ isOpen, onClose }: EntryManagerSidebarProps) {
