...
export default function Header({ onMenuToggle, sidebarOpen }: HeaderProps) {
  ...
  return (
    <header className="sticky top-0 z-30 bg-[#0d0d18]/80 backdrop-blur-xl shadow-[0px_20px_40px_rgba(13,13,24,0.6)] flex flex-row-reverse justify-between items-center w-full px-3 sm:px-6 lg:px-8 py-3 sm:py-4 gap-2">
      ...
      <div className="flex items-center gap-1 sm:gap-2 shrink-0">
        ...
        <HeaderComms messagesHref="/messages" notificationsHref="/notifications" />
