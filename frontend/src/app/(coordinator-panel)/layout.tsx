...
import CoordinatorSidebar from "@/components/coordinator-panel/CoordinatorSidebar";
...
export default function CoordinatorPanelLayout({
  children,
}: {
  ...
  useEffect(() => {
    ...
    const isCoordinator =
      ...
      storedUser?.membership?.member_role === "coordinator";
      ...
      <div className="flex items-center justify-center h-screen bg-[#0d0d18]">
        <div className="flex flex-col items-center gap-4">
          <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-[#5b2eff] to-[#c8bfff] flex items-center justify-center shadow-lg shadow-[#5b2eff]/30 animate-pulse">
            <span className="material-symbols-outlined text-white text-3xl">event_seat</span>
          </div>
    ...
    <div className="flex min-h-screen bg-[#0d0d18] text-on-surface">
      ...
      <div className="flex-1 flex flex-col min-w-0 lg:mr-[280px]">
        <CoordinatorHeader
          ...
          accountHref="/coordinator/account"
          defaultRoleLabel="منسق"
        />
